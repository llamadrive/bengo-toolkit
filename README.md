...
動作確認の次は `QUICKSTART.md` を開く。相続・離婚・交通事故の 3 シナリオで全 22 コマンドに触れる 30 分程度のウォークスルーを用意している。フィードバック窓口も同ドキュメントに記載。

### 覚えるコマンドは 3 つだけ

全 22 コマンドを覚える必要はない。以下のいずれかから始めれば自然に全機能に触れる:
